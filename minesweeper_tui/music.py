...
Ported from pysolfc-tui's pattern. Silent on failure. Bash-loop trap
kills paplay on SIGHUP/TERM/INT. Orphan cleanup on start.
"""
...
_SIGNATURE = "minesweeper_tui/assets/music/"
